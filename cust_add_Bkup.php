...
<div class="box-inner def">
          <div class="box-header well">
            <h2><i class="glyphicon glyphicon-list-alt"></i> Customer Add </h2>
<!--            <div class="box-icon">
                                        ...
                                        <td>
                                            <div class="ui-widget">
                                                <select name="country" id="country">
                                                    <option name='custCntry' value="CA">Canada</option>
                                                    <option name='custCntry' value="US">USA</option>
                                                </select>
                                            </div>
                                        ...
                                        <td>
                                            <div class="ui-widget">
                                                <select name="state" id="state">
                                                    <option name='custState' value="ON">Ontario</option>
                                                    <option name='custState' value="QC">Quebec</option>
                                                    <option name='custState' value="MB">Manitoba</option>
                                                    <option name='custState' value="NS">Nova Scotia</option>
                                                    <option name='custState' value="NB">New Brunswick</option>
                                                    <option name='custState' value="AB">Alberta</option>
                                                    <option name='custState' value="BC">British Columbia</option>
                                                    <option name='custState' value="NY">New York</option>
                                                    <option name='custState' value="TN">Tennessee</option>
