...
function loadReportUI(str)
{
    ...
    else if(str === "Bulk Product Movement Report")
    {
	$( "#mtdRow" ).show();
        $( "#folMoRow" ).show();
        $( "#folNoRow" ).show();
...
//					?>
				...
				<tr id="carrRow">
					...
					<select name="selDrExp" id="selDrExp">
                                ...
                                <tr id="rType">
                                    <td>
                                        <input type="radio" name="rptFormat" id="rptFormat" value="txtrpt" checked="checked"> &nbsp; Text
                                    </td>
				    <td>
                                        <input type="radio" name="rptFormat" id="rptFormat" value="txtpdf"> &nbsp; PDF
                                    </td>	
                                </tr>
                        <tr>    
