...
//            var vgno = document.getElementById('selVehicleGroup').value;
		    ...
		    var vgTxt = $("#selVehicleGroup option[value='"+vgno+"']").text();
	 	    ...
	 	    $("#txtGroupDesc").val(vgTxtArr[1]);
                    ...
                    {
                        //alert("No Vehicle Group record found for criterias specified !");
			alert("No Default Supplier, Customer and Account data assigned for this VehicleGroup !");
                        return;
                    }
