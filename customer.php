...
$( "#add" ).click(function() {
    window.open("cust_add.php",'_blank');
...
//						}
					?>
                        ...
                        <tr>    
                            <td></td><td>
                            <input type="button" name="button" id="query" value="Query" onClick="">
                            <input type="button" name="button" id="add" value="Add" onClick="">
                            <input type="button" name="button" id="update" value="Update" onClick="">
