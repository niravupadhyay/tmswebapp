			...
			xmlhttp.onreadystatechange = function() 
				...
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
				{
					document.getElementById("selCustomer").innerHTML = xmlhttp.responseText;
                                        document.getElementById("width_tmp_option").innerHTML = document.getElementById("selCustomer").selected; 
                                        document.getElementById("selCustomer").width = document.getElementById("width_tmp_select").width;
				}
			}
...
<!--						<label id="closeOnSelect1"><input type="checkbox"/> Close on selection</label>-->
				...
				<tr>
                                    <td>Supplier</td><td>
					<select id="selSupplier" name="selSupplier" class="chosen" onChange="showSupplier(this.value)">
					<!--<option value=""></option>-->
					<?php
						//$id = $_GET['id']  ;
